...
TEST_CASE("AddOctave", "midi_note_test")
{
  REQUIRE(add_octave(note::A, 0) == midi_note::A0);
  REQUIRE(add_octave(note::As, 0) == midi_note::As0);
  REQUIRE(add_octave(note::B, 0) == midi_note::B0);
  REQUIRE(add_octave(note::C, 1) == midi_note::C1);
  REQUIRE(add_octave(note::Cs, 1) == midi_note::Cs1);
  REQUIRE(add_octave(note::D, 1) == midi_note::D1);
  REQUIRE(add_octave(note::Ds, 1) == midi_note::Ds1);
  REQUIRE(add_octave(note::E, 1) == midi_note::E1);
  REQUIRE(add_octave(note::F, 1) == midi_note::F1);
  REQUIRE(add_octave(note::Fs, 1) == midi_note::Fs1);
  REQUIRE(add_octave(note::G, 1) == midi_note::G1);
  REQUIRE(add_octave(note::Gs, 1) == midi_note::Gs1);
  REQUIRE(add_octave(note::A, 1) == midi_note::A1);
  REQUIRE(add_octave(note::As, 1) == midi_note::As1);
  REQUIRE(add_octave(note::B, 1) == midi_note::B1);
  REQUIRE(add_octave(note::C, 2) == midi_note::C2);
  REQUIRE(add_octave(note::Cs, 2) == midi_note::Cs2);
  REQUIRE(add_octave(note::D, 2) == midi_note::D2);
  REQUIRE(add_octave(note::Ds, 2) == midi_note::Ds2);
  REQUIRE(add_octave(note::E, 2) == midi_note::E2);
  REQUIRE(add_octave(note::F, 2) == midi_note::F2);
  REQUIRE(add_octave(note::Fs, 2) == midi_note::Fs2);
  REQUIRE(add_octave(note::G, 2) == midi_note::G2);
  REQUIRE(add_octave(note::Gs, 2) == midi_note::Gs2);
  REQUIRE(add_octave(note::A, 2) == midi_note::A2);
  REQUIRE(add_octave(note::As, 2) == midi_note::As2);
  REQUIRE(add_octave(note::B, 2) == midi_note::B2);
  REQUIRE(add_octave(note::C, 3) == midi_note::C3);
  REQUIRE(add_octave(note::Cs, 3) == midi_note::Cs3);
  REQUIRE(add_octave(note::D, 3) == midi_note::D3);
  REQUIRE(add_octave(note::Ds, 3) == midi_note::Ds3);
  REQUIRE(add_octave(note::E, 3) == midi_note::E3);
  REQUIRE(add_octave(note::F, 3) == midi_note::F3);
  REQUIRE(add_octave(note::Fs, 3) == midi_note::Fs3);
  REQUIRE(add_octave(note::G, 3) == midi_note::G3);
  REQUIRE(add_octave(note::Gs, 3) == midi_note::Gs3);
  REQUIRE(add_octave(note::A, 3) == midi_note::A3);
  REQUIRE(add_octave(note::As, 3) == midi_note::As3);
  REQUIRE(add_octave(note::B, 3) == midi_note::B3);
  REQUIRE(add_octave(note::C, 4) == midi_note::C4);
  REQUIRE(add_octave(note::Cs, 4) == midi_note::Cs4);
  REQUIRE(add_octave(note::D, 4) == midi_note::D4);
  REQUIRE(add_octave(note::Ds, 4) == midi_note::Ds4);
  REQUIRE(add_octave(note::E, 4) == midi_note::E4);
  REQUIRE(add_octave(note::F, 4) == midi_note::F4);
  REQUIRE(add_octave(note::Fs, 4) == midi_note::Fs4);
  REQUIRE(add_octave(note::G, 4) == midi_note::G4);
  REQUIRE(add_octave(note::Gs, 4) == midi_note::Gs4);
  REQUIRE(add_octave(note::A, 4) == midi_note::A4);
  REQUIRE(add_octave(note::As, 4) == midi_note::As4);
  REQUIRE(add_octave(note::B, 4) == midi_note::B4);
  REQUIRE(add_octave(note::C, 5) == midi_note::C5);
  REQUIRE(add_octave(note::Cs, 5) == midi_note::Cs5);
  REQUIRE(add_octave(note::D, 5) == midi_note::D5);
  REQUIRE(add_octave(note::Ds, 5) == midi_note::Ds5);
  REQUIRE(add_octave(note::E, 5) == midi_note::E5);
  REQUIRE(add_octave(note::F, 5) == midi_note::F5);
  REQUIRE(add_octave(note::Fs, 5) == midi_note::Fs5);
  REQUIRE(add_octave(note::G, 5) == midi_note::G5);
  REQUIRE(add_octave(note::Gs, 5) == midi_note::Gs5);
  REQUIRE(add_octave(note::A, 5) == midi_note::A5);
  REQUIRE(add_octave(note::As, 5) == midi_note::As5);
  REQUIRE(add_octave(note::B, 5) == midi_note::B5);
  REQUIRE(add_octave(note::C, 6) == midi_note::C6);
  REQUIRE(add_octave(note::Cs, 6) == midi_note::Cs6);
  REQUIRE(add_octave(note::D, 6) == midi_note::D6);
  REQUIRE(add_octave(note::Ds, 6) == midi_note::Ds6);
  REQUIRE(add_octave(note::E, 6) == midi_note::E6);
  REQUIRE(add_octave(note::F, 6) == midi_note::F6);
  REQUIRE(add_octave(note::Fs, 6) == midi_note::Fs6);
  REQUIRE(add_octave(note::G, 6) == midi_note::G6);
  REQUIRE(add_octave(note::Gs, 6) == midi_note::Gs6);
  REQUIRE(add_octave(note::A, 6) == midi_note::A6);
  REQUIRE(add_octave(note::As, 6) == midi_note::As6);
  REQUIRE(add_octave(note::B, 6) == midi_note::B6);
  REQUIRE(add_octave(note::C, 7) == midi_note::C7);
  REQUIRE(add_octave(note::Cs, 7) == midi_note::Cs7);
  REQUIRE(add_octave(note::D, 7) == midi_note::D7);
  REQUIRE(add_octave(note::Ds, 7) == midi_note::Ds7);
  REQUIRE(add_octave(note::E, 7) == midi_note::E7);
  REQUIRE(add_octave(note::F, 7) == midi_note::F7);
  REQUIRE(add_octave(note::Fs, 7) == midi_note::Fs7);
  REQUIRE(add_octave(note::G, 7) == midi_note::G7);
  REQUIRE(add_octave(note::Gs, 7) == midi_note::Gs7);
  REQUIRE(add_octave(note::A, 7) == midi_note::A7);
  REQUIRE(add_octave(note::As, 7) == midi_note::As7);
  REQUIRE(add_octave(note::B, 7) == midi_note::B7);
  REQUIRE(add_octave(note::C, 8) == midi_note::C8);
  REQUIRE(add_octave(note::Cs, 8) == midi_note::Cs8);
  REQUIRE(add_octave(note::D, 8) == midi_note::D8);
  REQUIRE(add_octave(note::Ds, 8) == midi_note::Ds8);
  REQUIRE(add_octave(note::E, 8) == midi_note::E8);
  REQUIRE(add_octave(note::F, 8) == midi_note::F8);
  REQUIRE(add_octave(note::Fs, 8) == midi_note::Fs8);
  REQUIRE(add_octave(note::G, 8) == midi_note::G8);
  REQUIRE(add_octave(note::Gs, 8) == midi_note::Gs8);
  REQUIRE(add_octave(note::A, 8) == midi_note::A8);
  REQUIRE(add_octave(note::As, 8) == midi_note::As8);
  REQUIRE(add_octave(note::B, 8) == midi_note::B8);
  REQUIRE(add_octave(note::C, 9) == midi_note::C9);
  REQUIRE(add_octave(note::Cs, 9) == midi_note::Cs9);
  REQUIRE(add_octave(note::D, 9) == midi_note::D9);
  REQUIRE(add_octave(note::Ds, 9) == midi_note::Ds9);
  REQUIRE(add_octave(note::E, 9) == midi_note::E9);
  REQUIRE(add_octave(note::F, 9) == midi_note::F9);
  REQUIRE(add_octave(note::Fs, 9) == midi_note::Fs9);
  REQUIRE(add_octave(note::G, 9) == midi_note::G9);
}